...
class VGGTResult:
    ...
    def save(self, path: Path, extra: dict[str, Any] | None = None) -> Path:
        payload: dict[str, Any] = {
            ...
            "images": (self.images * 255.0).clip(0, 255).astype(np.uint8),
            "frame_names": np.array(self.frame_names, dtype=object),
        }
...
def _resolve_checkpoint(
    checkpoint: str, hf_token: str, cache_dir: Path, image_resolution: int = 512
) -> str | None:
